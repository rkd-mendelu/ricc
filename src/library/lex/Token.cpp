...
Token::Token(Token::tokenType t) : _tokenType(t), _originalTokenType(t) {}

Token::Token(Token::tokenType t, std::string s)
    : _text(s), _tokenType(t), _originalTokenType(t) {}

size_t Token::getID() { return this->_id; }

void Token::setID(size_t id) { this->_id = id; }
...
void Token::alloc() { this->_allocated = true; }

bool Token::isAllocated() { return this->_allocated; }

Token::tokenType Token::getTokenType() { return this->_tokenType; }

void Token::setTokenType(tokenType t) { this->_tokenType = t; }

Token::tokenType Token::getOriginalTokenType() {
  return this->_originalTokenType;
}

void Token::setOriginalTokenType(tokenType t) { this->_originalTokenType = t; }

void Token::addChar(char c) { this->_text.push_back(c); }

std::string Token::getText() { return this->_text; }
...
bool Token::isRValue() {
  return this->getTokenType() == P_RVALUE ||
         this->getTokenType() == IDENTIFIER || this->isLiteral();
}
...
bool Token::isTerminal() {
  return this->getTokenType() != P_RVALUE &&
         ...
         this->getTokenType() != P_REDUCE && this->getTokenType() != P_SHIFT;
}
