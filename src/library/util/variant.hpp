...
struct typelist_max<typelist<Head, Tail> > {
 ...
 public:
  ...
  typedef
      typename conditional<(sizeof(Head) > tail_value), Head, tail_type>::type
          type;
};
...
struct helper {
  ...
  static type_index_t move(type_index_t const from_index, void* from_value,
                           void* to_value) {
    switch (from_index) {
      case 0:
  ...
  static type_index_t copy(type_index_t const from_index,
...
class variant {
 ...
 public:
          ...
          std::is_nothrow_move_constructible<
              ...
              std::is_nothrow_move_constructible<
                  ...
                  std::is_nothrow_move_constructible<
                      ...
                      value&& std::is_nothrow_move_constructible<T8>::value&&
  ...
  ~variant() { helper_type::destroy(type_index, ptr()); }
  ...
  variant_constexpr std::size_t index_of() const variant_noexcept {
    return to_size_t(
        detail::typelist_index_of<variant_types,
                                  typename detail::remove_cv<T>::type>::value);
  }
...
inline typename detail::add_pointer<T>::type get_if(
  ...
  return (pv->index() == pv->template index_of<T>()) ? &get<T>(*pv)
                                                     : variant_nullptr;
}
...
inline void swap(variant<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12,
                 ...
                 variant<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12,
                         T13, T14, T15>& b) variant_noexcept {
  a.swap(b);
}
