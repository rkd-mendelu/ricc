...
int main() {
  ...
  std::string inputProgram(
      "10 < 0; 555.5 == 555.5; 1!=2; 0> -5; c && a; d || b;");
  ...
  RICC::Token::tokenType expectedResult[] = {
      RICC::Token::INTEGER,    RICC::Token::LESS,       RICC::Token::INTEGER,
      RICC::Token::SEMICOLON,  RICC::Token::FLOAT,      RICC::Token::EQUAL,
      RICC::Token::FLOAT,      RICC::Token::SEMICOLON,  RICC::Token::INTEGER,
      RICC::Token::NOT_EQUAL,  RICC::Token::INTEGER,    RICC::Token::SEMICOLON,
      RICC::Token::INTEGER,    RICC::Token::LARGE,      RICC::Token::MINUS,
      RICC::Token::INTEGER,    RICC::Token::SEMICOLON,  RICC::Token::IDENTIFIER,
      RICC::Token::AND,        RICC::Token::IDENTIFIER, RICC::Token::SEMICOLON,
      RICC::Token::IDENTIFIER, RICC::Token::OR,         RICC::Token::IDENTIFIER,
