...
int main() {
  ...
  RICC::Token::tokenType expectedResult[] = {
      RICC::Token::INTEGER,   RICC::Token::PLUS,      RICC::Token::INTEGER,
      RICC::Token::SEMICOLON, RICC::Token::INTEGER,   RICC::Token::MINUS,
      RICC::Token::INTEGER,   RICC::Token::SEMICOLON, RICC::Token::INTEGER,
      RICC::Token::DIV,       RICC::Token::INTEGER,   RICC::Token::SEMICOLON,
      RICC::Token::INTEGER,   RICC::Token::MULTI,     RICC::Token::INTEGER,
