...
std::map<std::string, std::pair<int, int> > tests{
    ...
    {"int bar () {foo(bar,);}",
     {EXPRESSION_ERROR, 8}},  // FIXME WAS SYNTAX_ERROR now EXPRESSION_ERROR
    //                   ⬑------------┛
    ...
    //                           ⬑--------------------------------┛
    {"int main (int argc) {string candy, shop; foo(bar9); return a;}",
     {RET_OK, 22}},
    {"int main (int argc) {string candy, shop;; foo(bar9); return a;}",
     {SYNTAX_ERROR, 23}},
    //                                        ⬑--------------------------------┛
    {"int main (int argc) {string candy=shop; foo(bar9); return a;}",
     {RET_OK, 24}},
    {"int main (int argc) {string candy=shop, asdf=\"Ahoj\"; foo(bar9); return "
     "a;}",
     {RET_OK, 25}},
    {"int main (int argc) {string candy=shop, asdf=\"Ahoj\" return a;}",
     {SYNTAX_ERROR, 26}},
    //                                                     ⬑--------------------┛
    ...
    {"int david () {if(zidan){print(9);}else; return sufurki;}",
     {SYNTAX_ERROR, 31}},
    //                                      ⬑---------------------------┛
    {"int david () {if(zidan){print(9);}else{a=9} return sufurki;}",
     {SYNTAX_ERROR, 32}},
    //                                          ⬑---------------------------┛
    {"int david () {if(zidan){if(motorko){print(9);}else{}}else{return "
     "sufurki;}}",
     {RET_OK, 33}},
    {"int david () {while(zidan){if(motorko){print(9);}else{}}return sufurki;}",
     {RET_OK, 34}},
    {"int david () {while( ){if(motorko){print(9);}else{}}return sufurki;}",
     {EXPRESSION_ERROR, 35}},
    //                    ⬑---------------------------------------------------------┛
    {"int david () {while(zidan)if(motorko){print(9);}else{}}return sufurki;}",
     {SYNTAX_ERROR, 36}},
    //                          ⬑---------------------------------------------------------┛
    {"int david () "
     "{while(zidan){if(motorko){print(9);}else{zidan=motorko},}return "
     "sufurki;}",
     {SYNTAX_ERROR, 37}},
    //                                                                    ⬑----------------------------┛
    {"int zidan () {for(int zidan; zidan<motorko; motorko = zidan){print(9);}}",
     {RET_OK, 38}},
    {"int zidan () {for( ; zidan<motorko; motorko = zidan){print(9);}}",
     {SYNTAX_ERROR, 39}},
    //                  ⬑-------------------------------------------------------┛
    {"int zidan () {for(int zidan; ; motorko = zidan){print(9);}}",
     {EXPRESSION_ERROR, 40}},
    //                            ⬑--------------------------------------------┛
    {"int zidan () {for(int zidan;( zidan <  motorko ); ){print(9);}}",
     {SYNTAX_ERROR, 41}},
    //                                                 ⬑-----------------------┛
    // {"int global(){} for(int zidan;( zidan <  motorko ); zidan = zidan + 1
    // ){print(9);}", {RET_OK, 42}}, // FIXME
    // tpj-parser/src/syntax/Syntax.cpp:736 uncomment to support for statement
    {"int global(){}; for(int zidan;( zidan <  motorko ); zidan = zidan + 1 "
     "){print(9);}",
     {SYNTAX_ERROR, 42}},
    //              ⬑----------------------------------------------------------------------------┛
